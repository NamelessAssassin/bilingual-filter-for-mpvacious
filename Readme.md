...
* **方式 一：手动下载**
    1. 点击[这个链接](https://github.com/mosaic-roll/bilingual-filter-for-mpvacious/releases/latest/download/mpvacious_custom_subtitle_filter.zip)下载最新版本压缩包 (Latest Release)。
...
* **方式 二：通过 Git 安装**
    ...
    ```bash
    git clone https://github.com/mosaic-roll/bilingual-filter-for-mpvacious.git mpvacious_custom_subtitle_filter
    ```
